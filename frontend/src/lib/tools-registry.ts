...
export const categories: CategoryInfo[] = [
  ...
  },
  {
    ...
    name: "Games",
    icon: "Gamepad2",
    description: "Daily puzzles, trivia, and mini-games",
  ...
  },
  {
    ...
    name: "Creative",
    icon: "Sparkles",
    description: "ASCII art, idea generator, life stats",
...
export const tools: Tool[] = [
  ...
  // Productivity extras
  {
    ...
    description: "Track daily habits with streaks and a heatmap — no login needed",
    category: "productivity",
    icon: "CalendarCheck",
    path: "/productivity/habit-tracker",
    keywords: ["habit tracker", "streak", "daily habits", "goals", "routine"],
    isNew: true,
  },
  {
    slug: "decision-maker",
    name: "Decision Maker Pro",
    description: "Weighted spin wheel and pros/cons matrix to settle any dilemma",
    category: "productivity",
    icon: "Shuffle",
    path: "/productivity/decision-maker",
    keywords: ["decision maker", "spin wheel", "pros cons", "random choice", "dilemma"],
    isNew: true,
  },
  // Text tool extras
  {
    ...
    description: "Paste a job description + resume to get a keyword match score",
    category: "text-tools",
    icon: "FileSearch",
    path: "/text-tools/ats-checker",
    keywords: ["ats checker", "resume score", "job description", "keyword match", "cv checker"],
    isNew: true,
    isPopular: true,
  },
  {
    ...
    description: "Get Flesch-Kincaid score, grade level, passive voice % and more",
    category: "text-tools",
    icon: "BookOpen",
    path: "/text-tools/readability-analyzer",
    keywords: ["readability", "flesch kincaid", "grade level", "passive voice", "text analysis"],
    isNew: true,
  },
  // Finance extras
  {
    ...
    description: "Get a recommended CTC negotiation range based on role, city & experience",
    category: "finance",
    icon: "HandCoins",
    path: "/finance/salary-negotiation",
    keywords: ["salary negotiation", "ctc calculator", "hike calculator", "india salary", "offer letter"],
    isNew: true,
    isPopular: true,
  },
  // Developer tool extras
  {
    ...
    description: "Generate Indian fake names, emails, phone numbers and addresses in bulk",
    category: "developer-tools",
    icon: "UserRoundPlus",
    path: "/developer-tools/fake-data-generator",
    keywords: ["fake data", "mock data", "indian names", "test data", "random data generator"],
    isNew: true,
    isPopular: true,
  },
  {
    slug: "code-beautifier",
    name: "Code Snippet Beautifier",
    description: "Style your code with themes, then copy or download as a PNG image",
    category: "developer-tools",
    icon: "PanelTop",
    path: "/developer-tools/code-beautifier",
    keywords: ["code screenshot", "code image", "carbon", "syntax highlight", "code share"],
    isNew: true,
  },
  // Games
  {
    slug: "word-puzzle",
    name: "Dev Jargon Word Puzzle",
    description: "Daily 5-letter tech & finance word puzzle — Wordle with a dev twist",
    category: "games",
    icon: "SquareCode",
    path: "/games/word-puzzle",
    keywords: ["wordle", "word puzzle", "daily game", "tech words", "dev jargon"],
    isNew: true,
    isPopular: true,
  },
  {
    ...
    description: "Test your WPM on code snippets, quotes & random facts — shareable results",
    category: "games",
    icon: "Keyboard",
    path: "/games/typing-speed",
    keywords: ["typing speed", "wpm", "words per minute", "typing test", "keyboard"],
    isNew: true,
    isPopular: true,
  },
  {
    ...
    keywords: ["memory game", "number memory", "recall", "brain training", "concentration"],
    isNew: true,
  },
  {
    slug: "daily-trivia",
    name: "Daily Trivia Quiz",
    description: "5 daily questions on tech, finance & general knowledge — build your streak",
    category: "games",
    icon: "CircleHelp",
    path: "/games/daily-trivia",
    keywords: ["trivia", "daily quiz", "tech quiz", "finance quiz", "general knowledge"],
    isNew: true,
    isPopular: true,
  },
  {
    slug: "css-color-guess",
    name: "Guess the CSS Color",
    description: "A color block is shown — type the hex code as close as possible",
    category: "games",
    icon: "Palette",
    path: "/games/css-color-guess",
    keywords: ["css color", "hex code game", "color quiz", "designer game", "dev game"],
    isNew: true,
  },
  // Creative
  {
    ...
    keywords: ["ascii art", "text art", "ascii generator", "figlet", "terminal art"],
    isNew: true,
  },
  {
    slug: "idea-generator",
    name: "Random Idea Generator",
    description: "Instant startup ideas, side project prompts & writing sparks at one click",
    category: "creative",
    icon: "Lightbulb",
    path: "/creative/idea-generator",
    keywords: ["idea generator", "startup ideas", "side project", "writing prompts", "random ideas"],
    isNew: true,
  },
  {
    slug: "life-stats",
    name: "Life Stats Calculator",
    description: "Enter your birthdate and discover mind-blowing stats about your life",
    category: "creative",
    icon: "HeartPulse",
    path: "/creative/life-stats",
    keywords: ["life stats", "birthdate calculator", "days lived", "heartbeats", "life calculator"],
    isNew: true,
    isPopular: true,
  },
];
